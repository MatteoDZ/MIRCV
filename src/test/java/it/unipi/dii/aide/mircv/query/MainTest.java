...
public class MainTest {
    ...
    public void mainTestNoCompression() throws IOException {
        ...
        assertEquals(List.of(1, 8, 5, 2, 6, 3),
        ...
        assertEquals(List.of(42, 47, 45, 40, 43, 41, 44, 48, 46, 39),
        ...
        assertEquals(List.of(2, 8, 3, 6, 1, 7, 5, 9, 4, 0),
